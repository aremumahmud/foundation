  ...
  const socialLinks = [
    {
      ...
      href: "https://facebook.com/foundationofhope"
    },
    {
      name: "Twitter",
      icon: (
      ...
      href: "https://twitter.com/foundationofhope"
    },
    {
      name: "Instagram",
      icon: (
      ...
      href: "https://instagram.com/foundationofhope"
    },
    {
      name: "LinkedIn",
      icon: (
      ...
      href: "https://linkedin.com/company/foundationofhope"
    }
  ];
        ...
        >
          ...
          <div className="footer-main">
            ...
            <motion.div className="footer-brand" variants={itemVariants}>
              <h3 className="footer-logo">Foundation of Hope</h3>
              <p className="footer-description">
                Bringing light to those in darkness, one step at a time. 
          ...
          <motion.div className="footer-bottom" variants={itemVariants}>
            <div className="footer-bottom-content">
              <p className="copyright">
                © 2024 Foundation of Hope. All rights reserved.
              </p>
